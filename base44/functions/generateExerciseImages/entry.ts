...
const ALL_EXERCISES = [
  ...
  "Barbell Row", "Battle Ropes",  "Flat Dumbbell Press", "Bicep Cable Curl",
  "Bent Over Rear Delt Raises", "Bicep Curl (Barbell)", "Bicep Curl Dumbbell Supinated", "Box Jump", "Bradford Press",
