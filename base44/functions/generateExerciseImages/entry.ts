...
const ALL_EXERCISES = [
  "Ab Wheel Rollouts", "Arnold Press (Dumbbell)", "Around the World", "Back Extension", "Back Extension (Machine)",
  "Ball Slams", "Barbell Row", "Battle Ropes", "Bench Press (Barbell)", "Bench Press (Dumbbell)", "Bicep Cable Curl",
  "Bent Over Lateral Raise", "Bicep Curl (Barbell)", "Bicep Curl Dumbbell Supinated", "Box Jump", "Bradford Press",
  ...
  "Chin Up", "Clean and Press", "Close Grip Smith Chest Press", "Crunch", "Dead Bug",
