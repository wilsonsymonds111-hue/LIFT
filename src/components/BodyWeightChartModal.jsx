          ...
          <div className="bg-white dark:bg-card rounded-2xl p-3">
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 5 }}>
                ...
                />
                <Line type="monotone" dataKey="weight" stroke={goalMode === 'cutting' ? '#fbbf24' : '#3b82f6'} strokeWidth={2.5} dot={(props) => { if (props.payload.weight == null) return false; return <circle cx={props.cx} cy={props.cy} r={props.payload.isLatest ? 5 : 4} fill={props.payload.isLatest ? (goalMode === 'cutting' ? '#f59e0b' : '#2563eb') : (goalMode === 'cutting' ? '#fbbf24' : '#3b82f6')} stroke="#fff" strokeWidth={2} />; }} activeDot={{ r: 6, fill: goalMode === 'cutting' ? '#f59e0b' : '#2563eb', stroke: '#fff', strokeWidth: 2 }} animationDuration={200} animationEasing="ease-out" />
