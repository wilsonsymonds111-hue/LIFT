    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-end" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-2 flex-shrink-0">
          ...
          <h1 className="text-base font-semibold text-black dark:text-foreground">Bodyweight</h1>
          ...
          <div className="bg-white dark:bg-card rounded-2xl p-3">
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 5 }}>
                ...
                />
                <Line type="monotone" dataKey="weight" stroke="#A855F7" strokeWidth={2.5} dot={(props) => { if (props.payload.weight == null) return false; return <circle cx={props.cx} cy={props.cy} r={props.payload.isLatest ? 5 : 4} fill={props.payload.isLatest ? '#6D28D9' : '#A855F7'} stroke="#fff" strokeWidth={2} />; }} activeDot={{ r: 6, fill: '#6D28D9', stroke: '#fff', strokeWidth: 2 }} animationDuration={200} animationEasing="ease-out" />
