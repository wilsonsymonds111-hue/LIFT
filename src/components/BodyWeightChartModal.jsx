          ...
          >
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={chartData} margin={{ top: 10, right: 0, left: 0, bottom: 5 }}>
                ...
                />
                <Line type="monotone" dataKey="weight" stroke="#3b82f6" strokeWidth={2} dot={(props) => { if (props.payload.weight == null || props.payload.isContext || props.payload.isFirstVisible) return false; return <circle cx={props.cx} cy={props.cy} r={props.payload.isLatest ? 5 : 4} fill="#fff" stroke="#3b82f6" strokeWidth={2} />; }} activeDot={(props) => { if (props.payload?.isContext || props.payload?.isFirstVisible) return false; return <circle cx={props.cx} cy={props.cy} r={6} fill="#fff" stroke="#3b82f6" strokeWidth={2} />; }} animationDuration={200} animationEasing="ease-out" />
