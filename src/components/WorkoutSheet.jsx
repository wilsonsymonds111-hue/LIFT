    ...
    >
      ...
      >
        <div className="relative flex items-center justify-between px-4 pt-1 pb-2 flex-shrink-0">
            ...
            <div ref={scrollContainerRef} className={`flex-1 overflow-y-auto px-4 pt-2 pb-24 ${exerciseDragActive ? 'drag-active' : ''}`} style={{ '--card-scale': exerciseDragActive ? '0.72' : '1' }} data-workout-scroll>
