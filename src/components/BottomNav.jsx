...
const BottomNav = memo(function BottomNav() {
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-around h-[50px] px-2 rounded-full bg-white/65 dark:bg-gray-800/40 backdrop-blur-xl shadow-[0_4px_24px_rgba(0,0,0,0.10)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.35)] ring-1 ring-white/30 dark:ring-white/[0.06]">
        {tabs.map(({ path, Icon }) => {
