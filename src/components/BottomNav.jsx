...
const BottomNav = memo(function BottomNav() {
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-around h-[50px] px-2 rounded-full bg-[#262626]/70 backdrop-blur-xl shadow-[0_4px_24px_rgba(0,0,0,0.35)] ring-1 ring-white/[0.08]">
        {tabs.map(({ path, Icon }) => {
