...
const SPLIT_IMAGES = {
  ...
  'ass-aesthetics': 'https://media.base44.com/images/public/6a16b583ab0ebad6332038a3/a45a6aa20_image.png',
};
        ...
        {isPhotoBackground ? (
          <>
            <img
              ...
              draggable={false}
              style={{ transform: `translateZ(0)${splitKey === 'ass-aesthetics' ? ' scale(1.05)' : ''}`, backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', imageRendering: '-webkit-optimize-contrast' }}
            />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 z-10" style={{ transform: 'translateZ(0)' }}>
              <div className="relative inline-block">
                <div
                  className="absolute"
                  style={{
                    top: '-8px', bottom: '-4px', left: '-10px', right: '-10px',
