...
const SPLIT_IMAGES = {
  ...
  'ass-aesthetics': 'https://media.base44.com/images/public/6a16b583ab0ebad6332038a3/aff79b862_image.png',
};
        ...
        {isPhotoBackground ? (
          <>
            <img
              ...
              draggable={false}
              style={{ left: '50%', transform: 'translateX(-50%) translateZ(0)', backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', imageRendering: '-webkit-optimize-contrast' }}
            />
