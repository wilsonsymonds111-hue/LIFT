    ...
    <>
      <div className={compact ? '' : 'px-4 py-2'}>
        <div
          ...
          className="relative rounded-2xl p-2.5 transition-all duration-150 hover:scale-[1.01] bg-white dark:bg-card border border-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] cursor-pointer active:scale-[0.98]"
        >
          {/* Header */}
