  ...
  return (
    <>
      <button
        ...
        className={`w-12 h-12 rounded-full overflow-hidden shadow-md hover:shadow-lg hover:scale-110 hover:ring-2 hover:ring-blue-400/50 active:scale-95 transition-all duration-150 flex-shrink-0 border-2 ${localStorage.getItem('goalMode') === 'cutting' ? 'border-amber-400' : 'border-border'} hover:border-blue-400/30`}
      >
        {profilePhoto ? (
